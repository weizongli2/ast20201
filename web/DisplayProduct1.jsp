...
// ResultSetMetaData meta = null;
 ...
 out.println("<input type='text' value= "+product_idpass+" id='product_id' name='product_id' style='display:none' />"
         + "<input type='image' class='thumbnail' style='width:100%;height:250px' src='"+category+"/"+rs.getString("subcategory")+"/"+rs.getInt("id")+"/1.jpg' onclick='this.form.m.value="+rs.getInt("id")+";'/>"
                 + "</form>");
